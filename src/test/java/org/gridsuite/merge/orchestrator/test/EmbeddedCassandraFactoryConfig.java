 ...
 */
package org.gridsuite.merge.orchestrator.test;
...
public class EmbeddedCassandraFactoryConfig {
    ...
    CassandraConnection cassandraConnection(Cassandra cassandra) {
        ...
        CqlDataSet.ofClasspaths("create_keyspace.cql", "merge_orchestrator.cql").forEachStatement(cassandraConnection::execute);
