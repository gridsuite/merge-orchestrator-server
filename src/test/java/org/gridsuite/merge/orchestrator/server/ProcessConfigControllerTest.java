...
public class ProcessConfigControllerTest {
    ...
    public void configTest() throws Exception {
        ...
        mvc.perform(get("/" + VERSION + "/configs/" + SWE_1D_UUID)
                ...
                .andExpect(content().contentTypeCompatibleWith(APPLICATION_JSON))
                .andExpect(content().json("{\"processUuid\":\"" + SWE_1D_UUID
                                                  + "\",\"process\":\"SWE_1D\",\"businessProcess\":\"1D\",\"tsos\":[\"FR\",\"ES\",\"PT\"],\"runBalancesAdjustment\":false,\"useLastBoundarySet\":true,"
                                                  + "\"eqBoundary\":null,\"tpBoundary\":null}", true));
        ...
        mvc.perform(get("/" + VERSION + "/configs/" + SWE_1D_UUID)
                ...
                .andExpect(content().json("{\"processUuid\":\"" + SWE_1D_UUID
                                                  + "\",\"process\":\"SWE_1D\",\"businessProcess\":\"1D\",\"tsos\":[\"FR\",\"ES\",\"PT\"],\"runBalancesAdjustment\":false,\"useLastBoundarySet\":true,"
                                                  + "\"eqBoundary\":null,\"tpBoundary\":null}"));
