package org.gridsuite.merge.orchestrator.server.config;
...
public class RabbitConsumerConfiguration {
    ...
    public ListenerContainerCustomizer<MessageListenerContainer> customizer() {
        ...
        return (container, destination, group) -> {
            if (container instanceof SimpleMessageListenerContainer smlc && Objects.equals(group, "mergeOrchestratorCaseImportGroup")) {
